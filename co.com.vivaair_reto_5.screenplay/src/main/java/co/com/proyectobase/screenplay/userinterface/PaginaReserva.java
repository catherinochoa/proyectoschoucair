...
public class PaginaReserva extends PageObject {
	...
	//Cabina
					  		   CABINA_ADULTO_1 = Target.the("Equipaje cabina adulto 1").located(By.xpath("//*[@id='divFCExtrasHandLuggage']/div[1]/div[1]/div/div[2]/div/div[1]/div[1]/div[1]")), //s2id_autogen81
					  		   CABINA_ADULTO_2 = Target.the("Equipaje cabina adulto 2").located(By.xpath("//*[@id='divFCExtrasHandLuggage']/div[1]/div[2]/div/div[2]/div/div[2]/div[1]/div[1]")), //s2id_autogen85
					  		   CABINA_NINO = Target.the("Equipaje cabina niño").located(By.xpath("//*[@id='divFCExtrasHandLuggage']/div[1]/div[3]/div/div[2]/div[1]/div[3]/div[1]/div[1]")), //s2id_autogen89

	//Bodega 
					  		   EQUIPAJE_ADICIONAL1_ADULTO_1 = Target.the("Equipaje adicional 1 adulto 1").located(By.xpath("//*[@id='divCheckInBaggage']/div[1]/div/div[1]/div/div[2]/div/div[1]/div[3]/div[1]")), //s2id_autogen93
					  		   EQUIPAJE_ADICIONAL1_ADULTO_2 = Target.the("Equipaje adicional 1 adulto 2").located(By.xpath("//*[@id='divCheckInBaggage']/div[1]/div/div[2]/div/div[2]/div/div[4]/div[3]/div[1]")), //s2id_autogen97
					  		   EQUIPAJE_ADICIONAL1_NINO = Target.the("Equipaje adicional 1 nino").located(By.xpath("//*[@id='divCheckInBaggage']/div[1]/div/div[3]/div/div[2]/div/div[7]/div[3]/div[1]")), //s2id_autogen101
	
	//Check-in aeropuerto
					  		   CHECKIN_ADULTO_1 = Target.the("Check-in adulto 1").located(By.xpath("//*[@id='divExtrasExpress']/div[1]/div[1]/div/div[2]/div/div[1]/div[1]/div[1]")), //s2id_autogen105
					  		   CHECKIN_ADULTO_2 = Target.the("Check-in adulto 2").located(By.xpath("//*[@id='divExtrasExpress']/div[1]/div[2]/div/div[2]/div/div[2]/div[1]/div[1]")), //s2id_autogen109
					  		   CHECKIN_NINO = Target.the("Check-in niño").located(By.xpath("//*[@id='divExtrasExpress']/div[1]/div[3]/div/div[2]/div/div[3]/div[1]/div[1]")), //s2id_autogen113

	//Fila rapida
					  		   FILA_RAPIDA = Target.the("Fila rapida").located(By.xpath("//*[@id='divExtrasExpressBaggage']/div[1]/div/div[2]/div[1]/div[1]/div[1]")), //s2id_autogen117
	
	//Cancela tranquilo
					  		   CANCELA = Target.the("Cancela tranquilo").located(By.xpath("//*[@id='divFCExtrasCancelProtection']/div[1]/div/div[2]/div[1]/div[1]")), //s2id_autogen121
	
	//Equipaje especial
					  		   EQUIPAJE_ESPECIAL_ADULTO_1 = Target.the("Equipaje especial adulto 1").located(By.xpath("//*[@id='divExtrasSpecialLuggage']/div/div[1]/div/div[2]/div/div[1]/div[1]/div[1]")), //s2id_autogen123
					  		   EQUIPAJE_ESPECIAL_ADULTO_2 = Target.the("Equipaje especial adulto 2").located(By.xpath("//*[@id='divExtrasSpecialLuggage']/div/div[2]/div/div[2]/div/div[2]/div[1]/div[1]")), //s2id_autogen129
					  		   EQUIPAJE_ESPECIAL_NINO = Target.the("Equipaje especial niño").located(By.xpath("//*[@id='divExtrasSpecialLuggage']/div/div[3]/div/div[2]/div/div[3]/div[1]/div[1]")), //s2id_autogen135
